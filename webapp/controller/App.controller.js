sap.ui.define([
	...
	return BaseController.extend("zaudgpms.audhatham.com.controller.App", {
		...
		onInit: function () {
			...
			// Listen for background user model updates
			var oEventBus = sap.ui.getCore().getEventBus();
			oEventBus.subscribe("UserChannel", "UserUpdated", this._updateUserInfo, this);

			// Also try immediately in case the model is already loaded
		...
		_onRouteMatchedGlobally: function (oEvent) {
			...
			var sKey = sRouteName;
			if (sRouteName === "GatePassDetail") {
				sKey = "GatePassCreation";
			}
