sap.ui.define([
	...
	return BaseController.extend("zaudgpms.audhatham.com.controller.ScrapGatepassCreation", {
		...
		onPrint: function () {
			var oData = this.getView().getModel("scrapGp").getData();
			if (!oData.sgpNo) {
				oData.sgpNo = "Draft-SGP";
			}
			this._generatePDF(oData);
		},
